...
while terminalApplicationStatus:
    ...
    try:
        if i == "-help":  # commands
            ...
            print("-listallsongs (artist) = [RESOURCE DEMANDING COMMAND] Provides a list of all of a given artists' songs by relevance")
            print("-listallsongsalpha (artist) = [RESOURCE DEMANDING COMMAND] Provides a list of all of a given artists' songs by alphanumerical order")
            print("-listsongs (number of songs) (artist) = Provides a list of a given length of a given artists' songs by relevance")
            print("-listsongsalpha (number of songs) (artist) = Provides a list of a given length of a given artists' songs by alphanumerical order")
